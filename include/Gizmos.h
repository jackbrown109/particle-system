...
public:
	...
	// Adds a billboard where the objects orientation always faces the camera
	static void		addBillboard(glm::vec4& a_position, glm::vec4& a_colour, glm::vec2 a_size, glm::mat4& a_camera);
